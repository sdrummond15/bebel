...
<?php if ($params->get('show_publish_date')) : ?>
		<dd class="published">
		<?php echo JText::sprintf(JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_JS2'))); ?>
		</dd>
<?php endif; ?>
...
<?php endif; ?>
	...
	<div class="img-fulltext img-fulltext-<?php echo htmlspecialchars($imgfloat); ?>">
	<img
