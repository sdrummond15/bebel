            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="form-horizontal"
                ...
                <fieldset>
                    ...
                    <?php if ($params->get('email_publish')) { ?>
                        <div class="control-group">
                            <div class="controls">
                                <input class="input-80" name="email" type="email" id="inputEmail"
                    ...
                    if ($params->get('message_publish')) {
                        ...
                        <div class="control-group">
                            <div class="controls">
                            <textarea class="input-80" name="message" rows="12" id="inputMessage"
                                      placeholder="<?php echo $params->get('fifield_name'); ?>"
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" name="sbutton" value="Send"
                                        class="btn <?php echo $params->get('button_color'); ?>"><?php echo $params->get('bs_name'); ?></button>
                            </div>
                        </div>
                        <?php
                    } else {
...
<script>
    ...
    jQuery(function () {
        jQuery(window).on('load resize', function () {
            ...
            var formContato = jQuery('.moduletable-contato').height() + 115;
            var menu = jQuery('#header_wrap').height();
            var copy = jQuery('#copyright').height();
            var telaH = jQuery(window).height();

            jQuery('#box3').css('min-height', telaH - menu - formContato - copy);
